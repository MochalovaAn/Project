...
байта, не прочитано и не содержитс€ в 'val_byte_stored'
*/
	...
	if (!end_of_data())
	{
		...
		if (!end_of_data())
		{
			...
			do {
				...
				else /* подготовка массива дл€
					 сравнений, в нем будут
					 хранитьс€ все идентичные байты */
				{
					*array = byte1;
					array[1] = byte2;
					...
					{ /* ƒа, тогда не считаем 2 последних байта */
...
//---------------------------------------------------------
// ¬ывод помощи о пользовании программой
void help()
{
